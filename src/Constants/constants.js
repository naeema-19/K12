...
const introduction = {
  text: [
    "The K12 - Signal House Project is a portable kiosk initiative designed to enhance the learning experience for high school students, focusing on the field of signal processing. This project aims to introduce and demonstrate signal processing concepts, techniques, and applications in an engaging and interactive manner",

    "The K12 - Signal House Project is structured to provide a one-hour immersive experience for each student, divided into four key components:",

    "1. Theoretical Formulation: Students receive an overview of signal processing concepts, from the basics to advanced levels, through engaging presentations and discussions.",
    
    "2. Technical Demonstration: The kiosk showcases practical applications of signal processing, allowing students to see real-world examples of how this field impacts our daily lives.",
    
    "3. Practical Session: Students have the opportunity for hands-on learning, engaging in activities and games that reinforce signal processing principles.",
    
   "4. Evaluation: Assessments and quizzes are conducted to gauge students understanding and interest in signal processing.",
